...
function DashboardView({ initialIncidents, candidateCount, indexedReports, researchSources, pipelineStatus, eventGroups }: DashboardProps) {
...
import {
  reviewedIncidents,
  candidates,
  indexedReports as indexedReportsData,
  researchSources,
  pipelineStatus,
  eventGroups,
} from "@shared/pvFireWatchData";

export default function Home() {
  return (
    <DashboardView
      initialIncidents={reviewedIncidents as unknown as DashboardProps["initialIncidents"]}
      candidateCount={candidates.length}
      indexedReports={indexedReportsData as unknown as DashboardProps["indexedReports"]}
      researchSources={researchSources as unknown as DashboardProps["researchSources"]}
      pipelineStatus={pipelineStatus as unknown as DashboardProps["pipelineStatus"]}
