...
export const metadata: Metadata = {
  title: "Data policy",
  description: "Licensing, privacy and responsible-use terms for Global PV Fire Watch.",
...
export default function DataPolicyPage() {
  return (
    ...
    >
      ...
      <section>
        <h2>Privacy</h2>
        <p>The dashboard has no first-party analytics, advertising cookies, user accounts or profiling. CSV exports are created in the visitor&apos;s browser. The hosting provider may process standard request logs for security and operations. External publishers apply their own privacy and cookie policies when a source link is opened.</p>
      </section>
      <section>
